...
public class ViewTopMonthly extends Activity implements OnItemClickListener,
		OnClickListener {
	...
	public void filtList() {
		...
		tmp = FiltAlgo.getMonthlyStock(reports, batches, stocks, c.getTime(),tv);
...
//			tvSpec.setText("");
	...
	public void onClick(View v) {
		...
		case R.id.rank_selector:
			new AlertDialog.Builder(ViewTopMonthly.this)
					.setTitle("Select Month")
					.setPositiveButton("Prev. Month",
					...
					.setNeutralButton("Current Month",
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int which) {
									// TODO Auto-generated method stub
